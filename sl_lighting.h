...
void sl_lighting_set_material(struct sm_vec3* ambient, struct sm_vec3* diffuse, 
	                          struct sm_vec3* specular, float shininess);
void sl_lighting_set_normal_matrix(union sm_mat3* mat);
void sl_lighting_set_light_position(struct sm_vec3* pos);
